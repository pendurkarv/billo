          ...
          <v-card-text>
            <v-container grid-list-sm>
              <v-layout wrap>
                ...
                <v-flex xs12 sm12 md12>
                  <v-text-field v-model="editedItem.gst_code" label="GST Code"></v-text-field>
                </v-flex>
                <v-flex xs12 sm12 md12>
...
<script>
import { fetchMasterList, addMasterItem, updateMasterItem, deleteMasterItem } from '@/api';
    ...
    deleteItem (item) {
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
          ...
          updateMasterItem('states', id, this.editedItem).then(() => {
            const snackbar = {
          ...
          addMasterItem('states', this.editedItem).then((data) => {
            const snackbar = {
